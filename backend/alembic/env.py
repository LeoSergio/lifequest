...
# Importamos nossas configurações e o Base dos modelos
...
# Sobrescrevemos a URL do banco com a URL do nosso .env!
...
# Define a metadata (onde os modelos vão se registrar)
